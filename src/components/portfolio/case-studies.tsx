      ...
      <div className="container">
        ...
        <div className="space-y-16 sm:space-y-20 lg:space-y-32">
          {caseStudies.map((study, index) => (
            ...
            >
              <div className="relative aspect-16/10 overflow-hidden rounded-3xl border">
                <Image
                  src={study.image}
                  alt={study.title}
                  fill
              ...
              <div>
                ...
                <div className="mt-8 grid grid-cols-1 gap-4 sm:mt-10 sm:grid-cols-3">
                  {study.results.map((result) => (
                    <div
                      key={result}
                      className="rounded-2xl border bg-background/60 p-4 text-center backdrop-blur sm:p-5"
                    >
