          ...
          {serviceBenefits.map((benefit, index) => {
            ...
            return (
              <motion.article
                ...
                className="group flex h-full flex-col rounded-3xl border border-border bg-background/70 p-6 backdrop-blur transition-all duration-300 hover:border-primary/30 hover:shadow-xl sm:p-8"
              >
                <div
                  aria-hidden="true"
